    ...
    var doc = window.document,
        ...
        _video = {
            youtube: {
                ...
                getUrl: function() {
                    return (
                        PROT + "//gdata.youtube.com/feeds/api/videos/" + this.id + "?v=2&alt=json-in-script&callback=?"
                    );
                },
        ...
        Finger.prototype = {
            ...
            ontouchmove: function(e) {
                ...
                if (this.isScrolling === null) {
                    this.isScrolling = !!(
                        this.isScrolling || M.abs(this.deltaX) < M.abs(touch[0].pageY - this.start.pageY)
                    );
                }
